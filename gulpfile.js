...
function _copyDevelopmentAssets() {
    var _css = gulp.src('node_modules/@tvontario/gvl/dist/ilc_core.css')
        .pipe(gulp.dest('test/vendor')); 
    
    var _css2 = gulp.src('node_modules/@tvontario/k8-bootstrap-css/scss/tvo_k8.css').pipe(gulp.dest('test/vendor'));
